    ...
    <main class="container">    
        <div class="row justify-content-center">
            <div class="col-10">
                ...
                <div class="col-12">
                    <h1 class="my-2 btn btn-block btn-info font-weight-bold col-12" style="cursor:default">Vous consultez vote compte</h1>
                    <Home></Home>
                </div>
                        ...
                        <div class="card bg-light my-3 class=center-block" style="float:none;">
                            <div class="card-header">
                                <div class="row justify-content-around">
                                    ...
                                    <button @click="localClear" class=" btn btn-secondary mx-auto rounded p-2 buttonsPanel"> Déconnexion </button>
                                </div>
                            </div>
                            ...
                            <div class="card-body mx-auto">
                                <div class=" rounded p-3" style="cursor:default"><button class="rounded p-2" style="cursor:default"><span class="m-3 font-weight-bold">Depuis cette page vous pouvez supprimer votre compte. La suppression de votre compte entrainera également la suppression de tous les commentaires et les images que vous avez posté.</span></button></div>
                            </div>
                            <div class="card-body mx-auto">
                                <div class="rounded p-3" style="cursor:default"><button @click="deleteMyAccount(id)" class="rounded p-2  btn btn-secondary mx-auto rounded p-2 buttonsPanel "><span class="m-3 font-weight-bold">SUPPRIMER VOTRE COMPTE</span></button></div>
                            </div>
                        </div> 
                    </div>  
                </section>
